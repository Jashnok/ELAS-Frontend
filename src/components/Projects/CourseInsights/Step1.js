            ...
            <Grid container direction="row" style={{ width: 500, paddingTop: 25 }}>
              <Grid item style={{ width: 500, paddingTop: 25 }} xs={10} sm={12} md={12} lg={12}>
                <Autocomplete
                  ...
                  renderInput={(params) => <TextField {...params} label="Search for your studyprogram here" variant="outlined" color="secondary" />}
                />
              </Grid>
            </Grid>
              ...
              <Grid container direction="row" style={{ width: 500, paddingTop: 25 }}>
                <Grid item spacing={1} style={{ width: 300 }} xs={8} sm={8} md={8} lg={8}>
                  <Autocomplete
                    ...
                    renderInput={(params) => <TextField {...params} label="Select your Semester" variant="outlined" color="secondary" />}
                  />
                </Grid>

                <Grid item spacing={10} style={{ width: 100 }} className={classes.button}>
                  <Button variant="contained" style={{ backgroundColor: "#3f51b5", color: "#fff", width: 70 }} onClick={handleNextButton1Clicked}>
                    next
                  </Button>
                  <Snackbar anchorOrigin={{ vertical: "top", horizontal: "center" }} open={noObjectDefined} autoHideDuration={6000} onClose={handleClose}>
                    <Alert variant="filled" onClose={handleClose} severity="error">
                      You have to select your studyprogram
                    </Alert>
                  </Snackbar>
                  <Snackbar anchorOrigin={{ vertical: "top", horizontal: "center" }} open={noSemesterDefined} autoHideDuration={6000} onClose={handleClose}>
                    <Alert variant="filled" onClose={handleClose} severity="error">
